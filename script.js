...
class Player {
  ...
  changeTurn() {
    ...
    playerTurnEl.style.backgroundImage = `url("./icon-${currentPlayer}.svg")`;
  }

  placeMark(element) {
    const mark = `<img src="./icon-${currentPlayer}.svg" alt="${currentPlayer}">`;
...
const ticTacToe = {
  ...
  winningDisplay() {
    ...
    winningMark.setAttribute("src", `./icon-${winner.mark}.svg`);
